    ...
    const html = `
      <header class="h-12 border-b border-slate-800 bg-slate-950 flex items-center px-4 flex-shrink-0 sticky top-0 z-50">
        ...
        <div class="flex items-center gap-2 text-slate-500">
          <a href="index.html" class="text-[11px] text-slate-500 hover:text-orange-300 transition-colors px-2 py-1 rounded hover:bg-slate-800" title="Prototype docs / outline">↗ Outline</a>
